...
var keyHolder = '';
var getKey = '';
var hornSound = new Audio('./assets/sounds/horn.wav')
...
$(document).ready(function() {
     ...
     dataRef.on("child_added", function(childSnapshot) {
		...
		$('.train-schedule').append("<tr class='table-row' id=" + "'" + childSnapshot.key() + "'" + ">" +
               ...
               "</td>" +
               "<td class='col-xs-1'>" + "<input type='submit' value='remove train' id='remove' class='remove-train btn btn-primary btn-sm'>" + "</td>" +
          "</tr>");
